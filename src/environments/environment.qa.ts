...
export class EnviromentHelper {
  public static URL_INSPECTIONS_WS = 'https://dyinspecwsqa.tipmexico.com/dyinspectionws';
  public static URL_CATALOG_WS = 'https://dycatwsqa.tipmexico.com/dycatalogws';
  public static URL_CONFIGURATION_WS = 'https://dyconfwsqa.tipmexico.com/dyconfigurationws';
  public static URL_HUMANRESOURCES_WS = 'https://dyhrwsqa.tipmexico.com/dyhumanresourcesws';
  public static URL_ENTRIES_WS = 'https://dyentrywsqa.tipmexico.com/dyentryws';
  public static URL_WORK_ORDERS_WS = 'https://dywkordrwsqa.tipmexico.com/dyworkorderws';
  public static URL_FILES_WS = 'https://dyfilewsqa.tipmexico.com/dyfilews';
  public static URL_FLEETS = 'https://dyfleetwsqa.tipmexico.com/dyfleetws';
  public static URL_SECURITY_WS = 'https://dysecwsqa.tipmexico.com/dysecurityws';
  ...
  public static readonly AUTH: AuthConfig = {
    domain: 'authqa.tipmexico.com',
    clientId: 'hQV5E2VxWajpQiSWKAdMER84c52ciPt0',
    authorizationParams: {
      audience: 'dyws-tip-api',
      organization: 'org_BQEvFU5qKfHON7KA',
      redirect_uri: window.location.origin
    }
  };

  public static readonly AUTH_CALLBACK = 'https://dywaqa.tipmexico.com/';
}
